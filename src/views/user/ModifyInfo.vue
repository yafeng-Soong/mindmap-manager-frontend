  ...
  export default {
    ...
    data(){
      return{
        ...
        showUpload: null,
        showIcons: {"username":false,"signature":false},
        showEdits: {"username":false,"signature":false},
        newValues: {"username":null,"signature":null},
        updateValyes: {},
        editType: {username:'username',signature:'signature'}
      }
    },
    created(){
